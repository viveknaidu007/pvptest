...
const getDashBoard = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const salesSummary = yield SaleModel_1.SaleModel.find({
        // take:5,
        // orderBy:{
        //     amount:"desc",
        // },
        });
        const purchaseSummary = yield PurchaseModel_1.PurchaseModel.find({
        // take:5,
        // orderBy:{
        //     amount:"desc",
        // },
        });
        const customerSummary = yield CustomerModel_1.CustomerModel.find({
        // take:5,
        // orderBy:{
        //     date:"desc",
        // },
